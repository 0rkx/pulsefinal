...
STEPS = [
    ...
    {
        "id":       "timeseries",
        "label":    "Time-series analysis (ARIMA + EWMA + CUSUM)",
    ...
    {
        "id":       "anomaly",
        "label":    "Anomaly detection (Isolation Forest + Mahalanobis)",
    ...
    {
        "id":       "lstm",
        "label":    "Deep learning model (TensorFlow bidirectional LSTM)",
        "module":   "deep_learning_model",
